...
**✅ 正确做法：**
```
浅色模式：白色背景 (#FFFFFF) + 深灰文字 (#212121 Material Grey-900)
暗色模式：深灰背景 (#212121) + 浅灰文字 (#FAFAFA Material Grey-50)
```
...
**解决方案：**
```
浅色模式对比度：16.1:1 (#212121 Material Grey-900 on #FFFFFF)
暗色模式对比度：18.5:1 (#FAFAFA Material Grey-50 on #212121)  ← 极佳对比度
```
...
**最后更新：** 2025-11-16
**相关文档：** [Design Token 规范](./README.md) | [Material Design 色板](./color-palette.md)
