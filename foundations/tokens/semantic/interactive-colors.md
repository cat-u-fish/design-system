...
| `interactive-primary-disabled` | Gray-300<br>#D1D5DB | Gray-700<br>#374151 | 主按钮禁用 |
...
| Token | 浅色模式 | 暗色模式 | 用途 |
|-------|---------|---------|------|
| `interactive-secondary` | Gray-600<br>#4B5563 | Gray-400<br>#9CA3AF | 次按钮默认 |
| `interactive-secondary-hover` | Gray-700<br>#374151 | Gray-300<br>#D1D5DB | 次按钮悬停 |
| `interactive-secondary-active` | Gray-800<br>#1F2937 | Gray-200<br>#E5E7EB | 次按钮按下 |
| `interactive-secondary-disabled` | Gray-300<br>#D1D5DB | Gray-700<br>#374151 | 次按钮禁用 |
...
| `interactive-danger-disabled` | Gray-300<br>#D1D5DB | Gray-700<br>#374151 | 危险按钮禁用 |
...
| Token | 浅色模式 | 暗色模式 | 用途 |
|-------|---------|---------|------|
| `interactive-icon` | Gray-600<br>#4B5563 | Gray-400<br>#9CA3AF | 默认图标 |
| `interactive-icon-hover` | Gray-900<br>#111827 | Gray-200<br>#E5E7EB | 图标悬停 |
| `interactive-icon-active` | Blue-600<br>#2563EB | Blue-400<br>#60A5FA | 图标激活 |
| `interactive-icon-disabled` | Gray-400<br>#9CA3AF | Gray-600<br>#4B5563 | 图标禁用 |
...
:root {
  ...
  --interactive-primary-disabled: #D1D5DB;
  ...
  /* 图标交互 */
  --interactive-icon: #4B5563;
  --interactive-icon-hover: #111827;
}
...
[data-theme="dark"] {
  ...
  --interactive-primary-disabled: #374151;
  ...
  /* 图标交互 */
  --interactive-icon: #9CA3AF;
  --interactive-icon-hover: #E5E7EB;
}
```
